...
<iframe src="https://editor.raspberrypi.org/nl-NL/embed/viewer/animated-story-upgraded?page=bella.html" width="100%" height="800" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>

Je kunt het [geüpgrade project hier](https://editor.raspberrypi.org/nl-NL/projects/animated-story-upgraded){:target="_blank"} bekijken.
