...
<iframe src="https://editor.raspberrypi.org/zh-CN/embed/viewer/animated-story-upgraded?page=bella.html" width="100%" height="800" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>

你可以在此处查看 [升级后的项目文件](https://editor.raspberrypi.org/zh-CN/projects/animated-story-upgraded){:target="_blank"}。
